...
- **Real-time Playback & Mixing:** The native C++ engine (`hymn_player_ext`) supports real-time playback and multi-channel mixing (`set_channel_volume`) for the Studio V3 interface.
