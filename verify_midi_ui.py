...
def verify_midi_ui():
    with sync_playwright() as p:
        ...
        # 6. Scroll down to External MIDI Control - Try focusing on the element
        midi_input_label = page.get_by_text("MIDI Input (Hardware/Controller)")
        midi_input_label.scroll_into_view_if_needed()
        time.sleep(2)
        # 7. Take screenshot
        page.screenshot(path="/home/jules/verification/v134_midi_ui_scrolled.png")
